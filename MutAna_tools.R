...
omicCircosUni <- function(listOfMap, label = NULL, minR, outfile,
  ...
  if (protocol == "panelTumor" & !(sureselect_type %in% c("V6","V5UTR","V6UTR", "V8UTR", "TwistCoreExome", "TwistComprehensiveExome", "xGenExomeResearchPanelV1", "xGenExomeResearchPanelV2"))) {
